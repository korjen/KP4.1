            ...
            <c:choose>
                ...
                <c:otherwise>
                    <sec:authorize access="hasRole('ROLE_ADMIN')">
                        <td><a href="<c:url value="/admin/workers/profile/getWorkerTime/${time.worker.idWorker}?page=${i}"/>">${i}</a></td>
                    </sec:authorize>
                    <sec:authorize access="hasRole('ROLE_MANAGER')">
                        <td><a href="<c:url value="/manager/workers/profile/getWorkerTime/${time.worker.idWorker}?page=${i}"/>">${i}</a></td>
                    </sec:authorize>
                </c:otherwise>
            </c:choose>
        </c:forEach>
