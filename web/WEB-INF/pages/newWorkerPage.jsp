...
<script>
    ...
    function validation() {
        ...
        x = document.getElementById('patronymic').value;;
        if (x == null || x == "") {
            alert("Отчество не было введено");
            return false;
        }
        return true;
    }
...
<div class="container">
    ...
    <div class="innerContainer">
        ...
        <div class="middle" align="center">
            <form:form id="addForm" action="addWorker" method="post" modelAttribute="worker" onsubmit="return validation()">
                <table id="list">
                    <tr>
